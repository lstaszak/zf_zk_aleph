  ...
  $.extend($.ui.tabs.prototype, {
    _tabify: function() {
      ...
      a.options.closable === true && this.lis.filter(function() {
        ...
        $(this).append('<a href="#" class="closechat"><span class="ui-icon ui-icon-circle-close"></span></a>').find("a:last").hover(function() {
          ...
          if (b > -1) {
            if (false === a._trigger("closableClick", null, a._ui($(a.lis[b]).find("a")[0], a.panels[b])))
              return;
            a.remove(b)
          }
          return false
