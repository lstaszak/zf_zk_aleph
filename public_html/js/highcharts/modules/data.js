  ...
  m.extend(n.prototype, {init: function(a) {
      ...
      b && (typeof b === "string" && (b = document.getElementById(b)), l(b.getElementsByTagName("tr"), function(a, b) {
        ...
        b >= c && b <= f && l(a.childNodes, function(a) {
          if ((a.tagName === "TD" || a.tagName === "TH") && g >= e && g <= j)
            d[g] || (d[g] = []), d[g][b - c] = a.innerHTML, g += 1
        })
      }))
      ...
      for (var a = this.columns, b = a.length, d, c, f, e; b--; )
        for (d = a[b].length; d--; )
          c = a[b][d], f = parseFloat(c), e = this.trim(c), e == f ? (a[b][d] = f, f > 31536E6 ? a[b].isDatetime = !0 : a[b].isNumeric = !0) : (c = Date.parse(c), b === 0 && typeof c === "number" && !isNaN(c) ? (a[b][d] = c, a[b].isDatetime = !0) : a[b][d] = e)
    }, parsed: function() {
      ...
      if (e.complete) {
        ...
        for (h = 0; h < a.length; h++) {
          ...
          for (i = 0; i < a[h].length; i++)
            g[i] = a[h][i] !== void 0 ? b ? [c[i], a[h][i]] : a[h][i] : null;
          j[h] = {name: k, data: g}
        }
