...
return array(
  ...
  // NIP i PESEL
  "'%value%' must contain 10 digits" => "'%value%' musi zawierać 10 znaków",
  "'%value%' must contain 11 digits" => "'%value%' musi zawierać 11 znaków",
  "Luhn algorithm (mod-11 checksum) failed on '%value%'" => "Luhn algorithm (mod-11 checksum) failed on '%value%'"
);
