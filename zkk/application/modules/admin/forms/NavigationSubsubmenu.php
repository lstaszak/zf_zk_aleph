...
class Admin_Form_NavigationSubsubmenu extends Zend_Form
{

  private $_aFilters = array("StringTrim");
  private $_aAllNavigationSubmenu = array();
  ...
  public function init()
  {
    ...
    $oSubmenuId = new Zend_Form_Element_Select("navigation_submenu_id");
    $oSubmenuId->setLabel("Submenu nadrzędne:");
    $oSubmenuId->setRequired(TRUE)->setAttrib("class", "valid");
    $oSubmenuId->addMultiOptions($this->_aAllNavigationSubmenu);
    $this->addElement($oSubmenuId);
    ...
    $oNavigationSubmenuCopy = new Zend_Form_Element_Hidden("navigation_subsubmenu_edit_id");
